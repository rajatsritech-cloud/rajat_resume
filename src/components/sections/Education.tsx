...
const Education = () => {
    return (
        <section className="py-20 bg-stone-50 border-b border-stone-100 relative overflow-hidden">
            {/* Liquid Accent */}
            ...
            <div className="container mx-auto px-6 lg:px-20 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-14">
                    <div className="lg:col-span-6">
                        ...
                        <h3 className="font-sans text-3xl md:text-4xl mb-8 text-stone-950 font-semibold leading-tight tracking-tight uppercase whitespace-nowrap">Education & <span className="font-light text-stone-400">Credentials.</span></h3>

                        <motion.div
                            whileHover={{ y: -5 }}
                            className="p-10 bg-white/70 backdrop-blur-2xl rounded-2xl border border-stone-200/60 shadow-lg relative group overflow-hidden cursor-pointer"
                        >
                            ...
                            <h4 className="font-sans text-2xl text-stone-950 font-semibold mb-3 uppercase leading-tight">B.Tech (Computer Science)</h4>
                            <p className="text-nobel-gold font-bold text-xs uppercase tracking-[0.3em] mb-5">Rajasthan Technical University (RTU)</p>
                            <p className="text-stone-500 text-[17px] font-light leading-relaxed mb-6 relative z-10">Specialized in Distributed Systems, Computer Science, and Software Engineering architectures.</p>
                        ...
                        <ul className="grid grid-cols-1 gap-5">
                            {[
                                ...
                                <motion.li
                                    ...
                                    className="flex items-center gap-5 p-6 bg-white/60 backdrop-blur-xl rounded-xl border border-stone-200/60 shadow-md hover:shadow-lg hover:border-nobel-gold/30 transition-all group cursor-pointer"
                                >
