...
const Profile = () => {
    return (
        <section id="profile" className="py-16 bg-stone-50 relative z-10 border-b border-stone-100 overflow-hidden">
            ...
            <div className="container mx-auto px-6 lg:px-20 relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 items-start">
                    <div className="lg:w-[35%] lg:sticky lg:top-32">
                        ...
                        <h2 className="font-sans text-3xl md:text-4xl font-semibold mb-8 text-stone-950 leading-[1.1] tracking-tight uppercase">Engineered <br /><span className="font-light text-stone-400">Excellence.</span></h2>
                        <div className="space-y-6 w-full max-w-lg">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="flex items-center gap-5 p-5 bg-white/60 backdrop-blur-xl rounded-2xl border border-stone-200/60 shadow-[0_8px_32px_0_rgba(0,0,0,0.03)] transition-all hover:bg-white hover:border-nobel-gold/30 hover:shadow-xl group cursor-pointer"
                                >
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-stone-950 font-semibold text-base">{item.value}</span>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
                    ...
                    <div className="lg:w-[65%]">
                        <div className="space-y-12">
                            <p className="text-xl md:text-2xl text-stone-950 font-sans font-medium leading-[1.4] tracking-tight max-w-3xl">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {[
                                    ...
                                    <motion.div
                                        key={i}
                                        whileHover={{ y: -5 }}
                                        className="group p-8 bg-white/40 backdrop-blur-lg border border-stone-200/40 rounded-2xl hover:border-nobel-gold/30 transition-all hover:shadow-lg h-full cursor-pointer"
                                    >
                                        <div className="flex items-center gap-4 mb-5">
                                            ...
                                            <h4 className="font-sans text-lg text-stone-950 font-semibold tracking-tight leading-snug">{feature.title}</h4>
                                        </div>
