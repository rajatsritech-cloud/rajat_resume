    ...
    return (
        ...
        >
            <div className="bg-white/[0.02] rounded-2xl border border-white/5 overflow-hidden shadow-xl transition-all duration-500 hover:shadow-[0_40px_100px_-20px_rgba(197,160,89,0.1)] hover:border-nobel-gold/30 flex flex-col lg:flex-row cursor-pointer">
                ...
                <div className="lg:w-[32%] bg-white/[0.01] p-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-white/5 relative">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="font-sans text-xl text-white font-semibold leading-tight mb-3 tracking-tight uppercase break-words whitespace-normal">{company}</h3>
                        <div className="flex flex-col gap-1">
                            <p className="text-stone-300 font-medium text-sm uppercase tracking-wide">{role}</p>
                    ...
                    <ul className="space-y-6">
                        {points.map((p, i) => (
                            <li key={i} className="flex gap-6 group/item items-start">
                                ...
                                <p className="text-stone-400 text-sm leading-relaxed font-light tracking-tight group-hover/item:text-stone-200 transition-colors">{p}</p>
                            </li>
                        ))}
                    </ul>
                </div>
...
const Experience = () => {
    return (
        <section id="experience" className="py-16 bg-stone-950 border-b border-white/5">
            <div className="container mx-auto px-6 lg:px-20">
                <div className="max-w-4xl mb-14">
                    ...
                    <h2 className="font-sans text-3xl md:text-4xl text-white font-semibold leading-[1.1] tracking-tight mb-6 uppercase">Career <br /><span className="font-light text-stone-500">Archive.</span></h2>
